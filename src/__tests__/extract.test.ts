...
it('homepage with searchParams', () => {
  ...
  assert.equal(extracted.homepage, 'http://example.com/?query=string&query2=string2')
})
...
it('homepage with hash and searchParams', () => {
  ...
  assert.equal(extracted.homepage, 'http://example.com/?query=string&query2=string2#readme')
})
...
it('homepage `github.com` with searchParams', () => {
  ...
  assert.equal(extracted.homepage, 'http://github.com/?query=string&query2=string2')
})
...
it('homepage `github.com` with hash (not #reaeme) and searchParams', () => {
  ...
  assert.equal(extracted.homepage, 'http://github.com/?query=string&query2=string2#repo-meta-edit')
})
